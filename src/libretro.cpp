...
const int font[16][5] = {
    ...
    {0xFC, 0xC0, 0xFC, 0x0C, 0xFC}, //2
    {0xFC, 0xC0, 0xFC, 0xC0, 0xFC}, //3
    {0xCC, 0xCC, 0xFC, 0xC0, 0xC0}, //4
    {0xFC, 0x0C, 0xFC, 0xC0, 0xFC}, //5
    {0xFC, 0x0C, 0xFC, 0xCC, 0xFC}, //6
    {0xFC, 0xC0, 0xC0, 0xC0, 0xC0}, //7
    {0xFC, 0xCC, 0xFC, 0xCC, 0xFC}, //8
    {0xFC, 0xCC, 0xFC, 0xC0, 0xC0}, //9
    {0x30, 0xCC, 0xFC, 0xCC, 0xCC}, //A
    {0x3C, 0xCC, 0x3C, 0xCC, 0x3C}, //B
    {0xF0, 0x0C, 0x0C, 0x0C, 0xF0}, //C
    {0x3C, 0xCC, 0xCC, 0xCC, 0x3C}, //D
    {0xFC, 0x0C, 0xFC, 0x0C, 0xFC}, //E
    {0xFC, 0x0C, 0xFC, 0x0C, 0x0C}, //F
    };
